package id.ac.polbeng.noviraasnani.workmanagerexample
...
import id.ac.polbeng.noviraasnani.workmanagerexample.databinding.ActivityMainBinding
        ...
        workManager.getWorkInfoByIdLiveData(id)
            .observe(this) { info ->
                if(info != null){
                    ...
                    activityHomeBinding.tvProgress.text = "Progress
                    $value%"
                }
                // 2
